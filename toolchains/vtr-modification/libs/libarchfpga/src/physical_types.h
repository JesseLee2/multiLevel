...
struct t_mux_same_from_inf {
    ...
    std::vector<std::string> from_cas;
    std::vector<std::string> from_zero;
    std::vector<std::string> from_omux;
...
struct t_imux_inf {
    ...
    bool twostage_mux_spec;
    int first_stage_switch_id;
    int zero_stage_switch_id;
    std::vector<t_firststage_mux_inf> first_stages;
    std::vector<t_secondstage_mux_inf> second_stages;
    std::vector<t_firststage_mux_inf> zero_stages;
};
...
struct t_gsb_inf {
    ...
    std::vector<t_firststage_mux_inf> first_stages;
    std::vector<t_secondstage_mux_inf> second_stages;
    std::vector<t_secondstage_mux_inf> zero_stages;
};
