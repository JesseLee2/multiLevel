...
static int get_start_node_ind(int start_x, int start_y, int target_x, int target_y, t_rr_type rr_type, int seg_index, int track_offset) {
    ...
    vector<int> medium_num = {device_ctx.medium_seg_inf.imux_mdeium_num_xory, device_ctx.medium_seg_inf.omux_mdeium_num_xory, device_ctx.medium_seg_inf.gsb_mdeium_num_xory};
    for (int i = 0; i < 3; i++){
