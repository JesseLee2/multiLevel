...
class SpiceInterface(object):
    ...
    def run(self, sp_path, parameter_dict):
        ...
        print(sp_dir)
        print(os.getcwd())
        os.chdir(os.path.dirname(os.path.dirname(sp_dir)))
        ...
        while (not hspice_success):
            ...
            subprocess.call(["hspice64", sp_filename], stdout=output_file, stderr=output_file)
        ...
        self.simulation_counter += len(next(iter(list(parameter_dict.values()))))
