def _generate_ptran_driver(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(
        "Xinv_" + mux_name + "_1 n_in n_1_1 n_vdd n_gnd inv Wn=inv_" + mux_name + "_1_nmos Wp=inv_" + mux_name + "_1_pmos\n")
    spice_file.write(
        "Xwire_" + mux_name + "_driver n_1_1 n_1_2 wire Rw=wire_" + mux_name + "_driver_res Cw=wire_" + mux_name + "_driver_cap\n")
    spice_file.write(
        "Xinv_" + mux_name + "_2 n_1_2 n_out n_vdd n_gnd inv Wn=inv_" + mux_name + "_2_nmos Wp=inv_" + mux_name + "_2_pmos\n")
...
def _generate_ptran_sense_only(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(
        "Xinv_" + mux_name + "_1 n_in n_out n_vdd n_gnd inv Wn=inv_" + mux_name + "_1_nmos Wp=inv_" + mux_name + "_1_pmos\n")
    spice_file.write(".ENDS\n\n\n")
...
def _generate_ptran_2lvl_mux_partial(spice_file, mux_name, implemented_mux_size, level1_size):
    ...
    for i in range(1, level1_size):
        ...
        spice_file.write("Xptran_" + mux_name + "_L1_" + str(
            i) + "h n_gnd " + new_node + " n_gnd n_gnd ptran Wn=ptran_" + mux_name + "_L1_nmos\n")
    ...
    spice_file.write(
        "Xptran_" + mux_name + "_L2 " + current_node + " n_gnd n_gnd n_gnd ptran Wn=ptran_" + mux_name + "_L2_nmos\n")
    spice_file.write(".ENDS\n\n\n")
...
def _generate_ptran_2lvl_mux_on(spice_file, mux_name, implemented_mux_size, level1_size, level2_size):
    ...
    spice_file.write("******************************************************************************************\n")
    spice_file.write(
        "* " + mux_name + " subcircuit (" + str(implemented_mux_size) + ":1), fully turned on (mux only)\n")
    spice_file.write("******************************************************************************************\n")
    ...
    # Write level 2 netlist
    spice_file.write(
        "Xptran_" + mux_name + "_L2 " + current_node + " n_2 n_gate n_gnd ptran Wn=ptran_" + mux_name + "_L2_nmos\n")
    current_node = "n_2"
    wire_counter = 1
    tran_counter = 1
    ...
    if level2_size == 1:
        ...
        for i in range(1, int(level2_size / 2)):
            ...
            spice_file.write("Xptran_" + mux_name + "_L2_" + str(
                tran_counter) + "h n_gnd " + new_node + " n_gnd n_gnd ptran Wn=ptran_" + mux_name + "_L2_nmos\n")
        ...
        if level2_size % 2 == 0:
            ...
            spice_file.write("Xwire_" + mux_name + "_L2_" + str(wire_counter) + " " + current_node + " n_out" +
                             ...
                             mux_name + "_L2_cap/" + str(level2_size - 1) + "'\n")
            spice_file.write("Xptran_" + mux_name + "_L2_" + str(
                tran_counter) + "h n_gnd n_out n_gnd n_gnd ptran Wn=ptran_" + mux_name + "_L2_nmos\n")
            wire_counter = wire_counter + 1
            tran_counter = tran_counter + 1
            new_node = "n_2_" + str(level2_size / 2)
            spice_file.write("Xwire_" + mux_name + "_L2_" + str(wire_counter) + " " + " n_out " + new_node +
...
def generate_ptran_2lvl_mux(spice_filename, mux_name, implemented_mux_size, level1_size, level2_size):
    ...
    spice_file.write(
        "X" + mux_name + "_on_mux_only n_in n_1_1 n_gate n_gate_n n_vdd n_gnd " + mux_name + "_on_mux_only\n")
...
def _generate_ptran_2_to_1_mux_off(spice_filename, mux_name):
    """generate a off 2:1 mux"""
    spice_filename.write("******************************************************************************************\n")
    spice_filename.write("* " + mux_name + "_off" + " subcircuit (2:1)\n")
    spice_filename.write("******************************************************************************************\n")
    spice_filename.write(".SUBCKT " + mux_name + "_off n_in n_gate n_gate_n n_vdd n_gnd\n")
    spice_filename.write("Xptran_" + mux_name + "_L1 n_in n_gnd n_gnd n_gnd ptran Wn=ptran_" + mux_name + "_nmos\n")
    spice_filename.write(".ENDS\n\n\n")

#todo: 2:1 partial mux
...
def generate_ptran_2_to_1_mux(spice_filename, mux_name):
    ...
    _generate_ptran_2_to_1_mux_off(spice_file, mux_name)
    _generate_ptran_driver(spice_file, mux_name, 2)
    ...
    spice_file.write(
        "Xwire_" + mux_name + " n_1_1 n_1_2 wire Rw='wire_" + mux_name + "_res/2' Cw='wire_" + mux_name + "_cap/2'\n")
    spice_file.write(
        "Xwire_" + mux_name + "_h n_1_2 n_1_3 wire Rw='wire_" + mux_name + "_res/2' Cw='wire_" + mux_name + "_cap/2'\n")
    spice_file.write("Xptran_" + mux_name + "_h n_gnd n_1_3 n_gnd n_gnd ptran Wn=ptran_" + mux_name + "_nmos\n")

    spice_file.write("X" + mux_name + "_driver n_1_2 n_out n_vdd n_gnd " + mux_name + "_driver\n")
    '''
    spice_file.write("Xrest_" + mux_name + " n_1_2 n_2_1 n_vdd n_gnd rest Wp=rest_" + mux_name + "_pmos\n")
    spice_file.write(
        "Xinv_" + mux_name + "_1 n_1_2 n_2_1 n_vdd n_gnd inv Wn=inv_" + mux_name + "_1_nmos Wp=inv_" + mux_name + "_1_pmos\n")
    spice_file.write(
        "Xwire_" + mux_name + "_driver n_2_1 n_2_2 wire Rw=wire_" + mux_name + "_driver_res Cw=wire_" + mux_name + "_driver_cap\n")
    spice_file.write(
        "Xinv_" + mux_name + "_2 n_2_2 n_out n_vdd n_gnd inv Wn=inv_" + mux_name + "_2_nmos Wp=inv_" + mux_name + "_2_pmos\n")
    '''
    spice_file.write(".ENDS\n\n\n")
    spice_file.close()
...
def _generate_tgate_2lvl_mux_off(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(".SUBCKT " + mux_name + "_off n_in n_gate n_gate_n n_vdd n_gnd\n")
    spice_file.write(
        "Xtgate_" + mux_name + "_L1 n_in n_gnd n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L1_nmos Wp=tgate_" + mux_name + "_L1_pmos\n")
    spice_file.write(".ENDS\n\n\n")
...
def _generate_tgate_2lvl_mux_partial(spice_file, mux_name, implemented_mux_size, level1_size):
    ...
    # Write level 1 netlist
    spice_file.write(
        "Xtgate_" + mux_name + "_L1 n_in n_1 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L1_nmos Wp=tgate_" + mux_name + "_L1_pmos\n")
    current_node = "n_1"
    for i in range(1, level1_size):
        new_node = "n_1_" + str(i)
        spice_file.write("Xwire_" + mux_name + "_L1_" + str(i) + " " + current_node + " " + new_node +
                         " wire Rw='wire_" + mux_name + "_L1_res/" + str(level1_size) + "' Cw='wire_" +
                         mux_name + "_L1_cap/" + str(level1_size) + "'\n")
        spice_file.write("Xtgate_" + mux_name + "_L1_" + str(
            i) + "h n_gnd " + new_node + " n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L1_nmos Wp=tgate_" + mux_name + "_L1_pmos\n")
        current_node = new_node
    new_node = "n_1_" + str(level1_size)
    spice_file.write("Xwire_" + mux_name + "_L1_" + str(level1_size) + " " + current_node + " " + new_node +
                     " wire Rw='wire_" + mux_name + "_L1_res/" + str(level1_size) + "' Cw='wire_" +
    ...
    # Write level 2 netlist
    spice_file.write(
        "Xtgate_" + mux_name + "_L2 " + current_node + " n_gnd n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L2_nmos Wp=tgate_" + mux_name + "_L2_pmos\n")
    spice_file.write(".ENDS\n\n\n")
...
def _generate_tgate_2lvl_mux_on(spice_file, mux_name, implemented_mux_size, level1_size, level2_size):
    ...
    # Write level 2 netlist
    spice_file.write(
        "Xtgate_" + mux_name + "_L2 " + current_node + " n_2 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L2_nmos Wp=tgate_" + mux_name + "_L2_pmos\n")
    current_node = "n_2"
    wire_counter = 1
    tran_counter = 1
    # These are the switches below driver connection
    for i in range(1, (level2_size / 2)):
        ...
        spice_file.write("Xwire_" + mux_name + "_L2_" + str(wire_counter) + " " + current_node + " " + new_node +
                         " wire Rw='wire_" + mux_name + "_L2_res/" + str(level2_size - 1) + "' Cw='wire_" +
                         mux_name + "_L2_cap/" + str(level2_size - 1) + "'\n")
        spice_file.write("Xtagte_" + mux_name + "_L2_" + str(
            tran_counter) + "h n_gnd " + new_node + " n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L2_nmos Wp=tgate_" + mux_name + "_L2_pmos\n")
        wire_counter = wire_counter + 1
        tran_counter = tran_counter + 1
        current_node = new_node
    # These are the middle wires
    ...
    if level2_size % 2 == 0:
        ...
        spice_file.write("Xwire_" + mux_name + "_L2_" + str(wire_counter) + " " + " n_out " + new_node +
                         " wire Rw='wire_" + mux_name + "_L2_res/" + str(2 * (level2_size - 1)) + "' Cw='wire_" +
                         mux_name + "_L2_cap/" + str(2 * (level2_size - 1)) + "'\n")
        spice_file.write("Xtgate_" + mux_name + "_L2_" + str(
            tran_counter) + "h n_gnd " + new_node + " n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L2_nmos Wp=tgate_" + mux_name + "_L2_pmos\n")
        wire_counter = wire_counter + 1
        tran_counter = tran_counter + 1
        current_node = new_node
        ...
        spice_file.write("Xwire_" + mux_name + "_L2_" + str(wire_counter) + " " + current_node + " n_out" +
                         ...
                         mux_name + "_L2_cap/" + str(level2_size - 1) + "'\n")
        spice_file.write("Xtgate_" + mux_name + "_L2_" + str(
            tran_counter) + "h n_gnd n_out n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_L2_nmos Wp=tgate_" + mux_name + "_L2_pmos\n")
        wire_counter = wire_counter + 1
        tran_counter = tran_counter + 1
        new_node = "n_2_" + str(level2_size / 2)
        spice_file.write("Xwire_" + mux_name + "_L2_" + str(wire_counter) + " " + " n_out " + new_node +
...
def generate_tgate_2_to_1_mux(spice_filename, mux_name):
    ...
    spice_file.write(
        "Xtgate_" + mux_name + " n_in n_1_1 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_nmos Wp=tgate_" + mux_name + "_pmos\n")
    spice_file.write(
        "Xwire_" + mux_name + " n_1_1 n_1_2 wire Rw='wire_" + mux_name + "_res/2' Cw='wire_" + mux_name + "_cap/2'\n")
    spice_file.write(
        "Xwire_" + mux_name + "_h n_1_2 n_1_3 wire Rw='wire_" + mux_name + "_res/2' Cw='wire_" + mux_name + "_cap/2'\n")
    spice_file.write(
        "Xtgate_" + mux_name + "_h n_gnd n_1_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_" + mux_name + "_nmos Wp=tgate_" + mux_name + "_pmos\n")
    # spice_file.write("Xrest_" + mux_name + " n_1_2 n_2_1 n_vdd n_gnd rest Wp=rest_" + mux_name + "_pmos\n")
    spice_file.write(
        "Xinv_" + mux_name + "_1 n_1_2 n_2_1 n_vdd n_gnd inv Wn=inv_" + mux_name + "_1_nmos Wp=inv_" + mux_name + "_1_pmos\n")
    spice_file.write(
...
def generate_dedicated_driver(spice_filename, driver_name, num_bufs, top_name):
    ...
    count = 1
    spice_file.write("Xinv_" + driver_name + "_" + str(count) + " n_in n_1_" + str(
        count) + " n_vdd n_gnd inv Wn=inv_" + driver_name + "_" + str(1) + "_nmos Wp=inv_" + driver_name + "_" + str(
        1) + "_pmos\n")
    spice_file.write("Xwirer_edi_" + str(count) + " n_1_" + str(count) + " n_1_" + str(
        count + 1) + " wire Rw=wire_" + top_name + "_2_res/" + str(
        num_bufs * 2) + " Cw=wire_" + top_name + "_2_cap/" + str(num_bufs * 2) + " \n")
    count += 1
    for i in range(2, num_bufs * 2):
        spice_file.write("Xinv_" + driver_name + "_" + str(i) + " n_1_" + str(count) + " n_1_" + str(
            count + 1) + " n_vdd n_gnd inv Wn=inv_" + driver_name + "_" + str(
            i) + "_nmos Wp=inv_" + driver_name + "_" + str(i) + "_pmos\n")
        spice_file.write("Xwirer_edi_" + str(i) + " n_1_" + str(count + 1) + " n_1_" + str(
            count + 2) + " wire Rw=wire_" + top_name + "_2_res/" + str(
            num_bufs * 2) + " Cw=wire_" + top_name + "_2_cap/" + str(num_bufs * 2) + " \n")
        count += 2

    spice_file.write("Xinv_" + driver_name + "_" + str(num_bufs * 2) + " n_1_" + str(count) + " n_1_" + str(
        count + 1) + " n_vdd n_gnd inv Wn=inv_" + driver_name + "_" + str(
        num_bufs * 2) + "_nmos Wp=inv_" + driver_name + "_" + str(num_bufs * 2) + "_pmos\n")
    spice_file.write("Xwirer_edi_" + str(num_bufs * 2 + 1) + " n_1_" + str(
        count + 1) + " n_out wire Rw=wire_" + top_name + "_2_res/" + str(
        num_bufs * 2) + " Cw=wire_" + top_name + "_2_cap/" + str(num_bufs * 2) + " \n")
